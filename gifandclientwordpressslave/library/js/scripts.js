  ...
  */
  loadGravatars();
    ...
    channel.bind('client-my_event', function(data) {
      ...
      if (data.message === "takepicture") {
        channel.trigger('client-my_event', {"message": "foto-tomada", "foto": "http://i.imgur.com/2OO33vX.jpg", "foto2": "http://i.imgur.com/qOwVaSN.png"});
      };
      // alert(data.message);
    });
...
function sendImage(img) {
    channel.trigger('client-my_event', {"message": "hello world", });
